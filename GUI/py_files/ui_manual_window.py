...
class Ui_manual_window(object):
    def setupUi(self, manual_window):
        ...
        self.selectfile_btn.setSizePolicy(sizePolicy_btn)
        ...
        self.selectdir_btn.setSizePolicy(sizePolicy_btn)
        ...
        self.addmore_btn.setSizePolicy(sizePolicy_btn)
        ...
        self.addmorephasref_btn = QPushButton(self.calib_bottom)
        self.addmorephasref_btn.setObjectName(u"addmorephasref_btn")
        self.addmorephasref_btn.setFont(font3)

        self.addmorephasref_btn.setSizePolicy(sizePolicy_btn)

        self.gridLayout_4.addWidget(self.addmorephasref_btn, 2, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.phasref_line, 2, 1, 1, 1)
        ...
        self.addmoreshift_btn.setFont(font3)
        ...
        self.gridLayout_8.addWidget(self.chanout_line, 0, 1, 1, 2)
        ...
        self.gridLayout_8.addWidget(self.edgeflag_line, 1, 1, 1, 2)
    ...
    def retranslateUi(self, manual_window):
        ...
        self.addmoreshift_btn.setText(QCoreApplication.translate("manual_window", u"             Add more             ", None))
        self.timeaver_lbl.setText(QCoreApplication.translate("manual_window", u"Time average threshold", None))
        self.freqaver_lbl.setText(QCoreApplication.translate("manual_window", u"Freq. average threshold", None))
