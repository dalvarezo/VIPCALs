...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        self.gridLayout_2.addWidget(self.man_input_btn, 0, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.JSON_input_btn, 0, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.help_btn, 1, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.exit_btn, 1, 1, 1, 1)
    ...
    def retranslateUi(self, main_window):
        ...
        self.groupBox.setTitle(QCoreApplication.translate("main_window", u"Welcome", None))
